...
module Api
  module V1
    ...
    class UsersController < Api::V1::ApplicationController
      ...
      def login
        result = BrickProjectApi::Auth.login(params[:email], params[:password], @ip)
      ...
      def logout
        result = BrickProjectApi::Auth.logout(@current_user, @token)
      ...
      def create
        result = BrickProjectApi::Users.new_user(params)
